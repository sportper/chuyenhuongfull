...
return (
    ...
    <section className="bg-white overflow-hidden" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap items-center py-12 md:pb-10">
            <div className="w-full md:w-1/2 mb-6 md:mb-0">
              <p className="text-coolGray-400 font-medium">© All rights reserved.</p>
            </div>
